...
fetch_retroarch() {
   fetch_git "https://github.com/libretro/RetroArch.git" "retroarch" "libretro/RetroArch" "" ""
   fetch_git "https://github.com/libretro/common-shaders.git" "retroarch/media/shaders_cg" "libretro/common-shaders" "" ""
   fetch_git "https://github.com/libretro/common-overlays.git" "retroarch/media/overlays" "libretro/common-overlays" "" ""
   fetch_git "https://github.com/libretro/retroarch-assets.git" "retroarch/media/assets" "libretro/retroarch-assets" "" ""
   fetch_git "https://github.com/libretro/retroarch-joypad-autoconfig.git" "retroarch/media/autoconfig" "libretro/joypad-autoconfig" "" ""
   fetch_git "https://github.com/libretro/libretro-database.git" "retroarch/media/libretrodb" "libretro/libretro-database" "" ""
}
