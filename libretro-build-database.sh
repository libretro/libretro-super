...
build_libretro_databases() {
	...
	build_libretro_database "NEC - PC Engine CD - TurboGrafx-CD" "rom.name"
	...
	build_libretro_database "Sega - Mega-CD - Sega CD" "rom.name"
	build_libretro_database "Sega - Mega Drive - Genesis" "rom.crc"
	build_libretro_database "Sega - PICO" "rom.crc"
	build_libretro_database "Sega - Saturn" "rom.name"
